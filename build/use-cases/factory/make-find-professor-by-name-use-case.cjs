...
var make_find_professor_by_name_use_case_exports = {};
__export(make_find_professor_by_name_use_case_exports, {
  makeFindProfessorByNameUseCase: () => makeFindProfessorByNameUseCase
});
module.exports = __toCommonJS(make_find_professor_by_name_use_case_exports);
...
0 && (module.exports = {
  makeFindProfessorByNameUseCase
});
