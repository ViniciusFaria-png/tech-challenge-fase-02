...
// src/use-cases/factory/make-create-professor-use-case.ts
var make_create_professor_use_case_exports = {};
__export(make_create_professor_use_case_exports, {
  makeCreateProfessorUseCase: () => makeCreateProfessorUseCase
});
module.exports = __toCommonJS(make_create_professor_use_case_exports);
...
// src/use-cases/create-professor.ts
var CreateProfessorUseCase = class {
...
// src/use-cases/factory/make-create-professor-use-case.ts
function makeCreateProfessorUseCase() {
